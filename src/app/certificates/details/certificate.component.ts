...
export class CertificateComponent {
    ...
    ngOnInit() {
        this.icertificate = { certificate: {}, certificateId: null, leftLogo: './../../assets/images/2000px-EdX.png', rightLogo: './../../assets/images/bottom-right-logo.png' };
        this.icertificate.certificate = { UserName: "" }
        this.icertificate.certificateId = this.route.snapshot.paramMap.get("certificateId")
        if (this.icertificate.certificateId != null) {
            this._certificateService.getCertificateDetails().subscribe((data: ICertificateObj) => {
